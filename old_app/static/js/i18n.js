window.allTranslations = {
    ...
    "en": {
        ...
        "settingsVoiceGenderLabel": "Voice Gender",
        "settingsVoiceGenderMale": "Male",
        "settingsVoiceGenderFemale": "Female",
        "speechEuroSingular": "euro",
        "speechEuroPlural": "euros",
        ...
        "voiceErrorGeneric": "Error: {error}",
        "voiceKeywords": "pays with|gives me|received|hand over|paying with|total is",
        "voiceSplitSeparator": "with|and|point|dot",
        "wordToNum": {
    ...
    "gl": {
        ...
        "settingsSerialPlaceholder": "Escribe un comando...",
        "settingsSerialConsoleLabel": "Consola de comunicación",
        "settingsVoiceGenderLabel": "Xénero da Voz",
        "settingsVoiceGenderMale": "Masculina",
        "settingsVoiceGenderFemale": "Feminina",
        "speechEuroSingular": "euro",
        "speechEuroPlural": "euros",
        "speechCentSingular": "céntimo",
        "speechCentPlural": "céntimos",
        ...
        "voiceKeywords": "paga con|dame|dou|recibido|entrego|pagan",
        "voiceSplitSeparator": "con|punto|coma",
        "wordToNum": {
            "cero": 0, "un": 1, "dous": 2, "tres": 3, "catro": 4, "cinco": 5,
            "seis": 6, "sete": 7, "oito": 8, "nove": 9, "dez": 10, "once": 11,
            "doce": 12, "trece": 13, "catorce": 14, "quince": 15, "vinte": 20,
            "trinta": 30, "corenta": 40, "cincuenta": 50, "sesenta": 60,
            "setenta": 70, "oitenta": 80, "noventa": 90, "cen": 100
        }
    },
    "ca": {
        ...
        "voiceErrorGeneric": "Error: {error}",
        "voiceKeywords": "paga amb|me dóna|li dono|rebut|entrego|paguen",
        "voiceSplitSeparator": "amb|coma|punt",
        "wordToNum": {
            "zero": 0, "un": 1, "dos": 2, "tres": 3, "quatre": 4, "cinc": 5,
            "sis": 6, "set": 7, "vuit": 8, "nou": 9, "deu": 10, "onze": 11,
            "dotze": 12, "tretze": 13, "catorze": 14, "quinze": 15, "vint": 20,
            "trenta": 30, "quaranta": 40, "cinquanta": 50, "seixanta": 60,
            "setanta": 70, "vuitanta": 80, "noranta": 90, "cent": 100
        },
        "noHistory": "No s'han registrat operacions.",
        "historyLoadError": "Error en carregar l'historial."
    },
    "va": {
        "appTitle": "Calculadora de Canvi - ONCE App",
        "historyPageTitle": "Historial d'Operacions - ONCE App",
        ...
        "serverCommunicationError": "Error en la comunicació amb el servidor.",
        "voiceErrorGeneric": "Error: {error}",
        "voiceKeywords": "paga amb|me dóna|li donc|rebut|entrego|paguen",
        "voiceSplitSeparator": "amb|coma|punt",
        "wordToNum": {
            "zero": 0, "un": 1, "dos": 2, "tres": 3, "quatre": 4, "cinc": 5,
            "sis": 6, "set": 7, "vuit": 8, "nou": 9, "deu": 10, "onze": 11,
    ...
    "eu": {
        ...
        "settingsVoiceGenderLabel": "Ahotsaren Generoa",
        "settingsVoiceGenderMale": "Gizonezkoa",
        "settingsVoiceGenderFemale": "Emakumezkoa",
        "speechEuroSingular": "euro",
        ...
        "voiceValuesRecognized": "Valioak ezagututa",
        "voiceInterpretError": "Ezin izan da interpretatu.",
        "voiceErrorGeneric": "Errorea: {error}",
        "voiceKeywords": "ordaindu du|eman dit|jaso dut|hara emanda",
        "voiceSplitSeparator": "eta|puntu|komma",
        "wordToNum": {
            "zero": 0, "bat": 1, "bi": 2, "hiru": 3, "lau": 4, "bost": 5,
            "sei": 6, "zazpi": 7, "zortzi": 8, "bederatzi": 9, "hamar": 10, "hamaika": 11,
            "hamabi": 12, "hamahiru": 13, "hamalau": 14, "hamabost": 15, "hogei": 20,
            "hogeita": 20, "hogeitamar": 30, "berrogei": 40, "berrogeitamar": 50, "hirurogei": 60,
            "hirurogeitamar": 70, "laurogei": 80, "laurogeitamar": 90, "ehun": 100
        },
        "noHistory": "Ez dago erregistratutako eragiketarik.",
        "historyLoadError": "Errorea historial kargatzean."
    },
    "fr": {
        "appTitle": "Calculateur de Monnaie - ONCE App",
        "historyPageTitle": "Historique des Transactions - ONCE App",
        "settingsPageTitle": "Paramètres - ONCE App",
        "navCalculator": "Calculateur",
        "navHistory": "Historique",
        "navSettings": "Paramètres",
        "calculatorTitle": "Calculateur de Monnaie",
        "totalToPayLabel": "Total à Payer (€)",
        "totalToPayPlaceholder": "Ex: 5.50",
        "amountReceivedLabel": "Montant Reçu (€)",
        "amountReceivedPlaceholder": "Ex: 10.00",
        "calculateButton": "Calculer",
        "voiceInputButtonLabel": "Utiliser l'entrée vocale",
        "voiceErrorPermission": "Accès au microphone refusé. Pour utiliser cette fonction, veuillez autoriser l'accès au microphone dans votre navigateur.",
        "voiceErrorNoSpeech": "Aucune voix n'a été détectée. Réessayez en parlant près du microphone.",
        "voiceErrorInfo": "Erreur de reconnaissance : {error}. Veuillez réessayer.",
        "voiceErrorTimeout": "La reconnaissance vocale s'est arrêtée pour cause d'inactivité.",
        "voiceErrorStart": "Impossible de démarrer la reconnaissance. Assurez-vous que le microphone est autorisé et n'est pas utilisé.",
        "voiceErrorUnsupported": "Désolé, votre navigateur ne supporte pas la reconnaissance vocale.",
        "changeResultText": "La monnaie à rendre est : {change} €",
        "invalidInputText": "Veuillez saisir des montants valides.",
        "amountReceivedLowText": "Le montant reçu est inférieur au total à payer.",
        "historyTitle": "Historique des Transactions",
        "historyHeaderDate": "Date et Heure",
        "historyHeaderTotal": "Total Payé",
        "historyHeaderReceived": "Montant Reçu",
        "historyHeaderChange": "Monnaie Rendue",
        "settingsTitle": "Paramètres",
        "settingsDarkModeLabel": "Mode Sombre",
        "settingsLanguageLabel": "Langue",
        "settingsLangSpanish": "Espagnol",
        "settingsLangEnglish": "Anglais",
        "settingsLangGalician": "Galicien",
        "settingsLangCatalan": "Catalan",
        "settingsLangValencian": "Valencien",
        "settingsLangBasque": "Basque",
        "settingsLangFrench": "Français",
        "settingsSerialTitle": "Communication avec Dispositif Externe",
        "settingsSerialDescription": "Connectez un appareil via USB pour envoyer et recevoir des données.",
        "settingsMachineModelLabel": "Modèle de Machine",
        "settingsMachineModelS": "Modèle S (Basique)",
        "settingsMachineModelM": "Modèle M (Standard)",
        "settingsMachineModelMax": "Modèle MAX (Complet)",
        "settingsSerialConnect": "Connecter l'Appareil",
        "settingsSerialSend": "Envoyer",
        "settingsSerialPlaceholder": "Tapez une commande...",
        "settingsSerialConsoleLabel": "Console de communication",
        "settingsVoiceGenderLabel": "Genre de la Voix",
        "settingsVoiceGenderMale": "Masculin",
        "settingsVoiceGenderFemale": "Féminin",
        "speechEuroSingular": "euro",
        "speechEuroPlural": "euros",
        "speechCentSingular": "centime",
        "speechCentPlural": "centimes",
        "speechCon": "et",
        "speechCero": "zéro",
        "speechOneEuro": "un euro",
        "speechOneCent": "un centime",
        "speechChangeResultText": "La monnaie à rendre est :",
        "serverCommunicationError": "Erreur de communication avec le serveur.",
        "genericError": "Une erreur est survenue. Veuillez réessayer.",
        "voiceErrorInitFailed": "Impossible d'initialiser la reconnaissance.",
        "voiceProcessing": "Traitement...",
        "voiceValuesRecognized": "Valeurs reconnues",
        "voiceInterpretError": "Impossible d'interpréter.",
        "voiceErrorGeneric": "Erreur : {error}",
        "voiceKeywords": "paye avec|me donne|reçu|donne|payant",
        "voiceSplitSeparator": "et",
        "noHistory": "Aucun historique enregistré.",
        "historyLoadError": "Erreur lors du chargement de l'historique.",
        "voiceKeywords": "paye avec|me donne|reçu|donne|total est",
        "voiceSplitSeparator": "et|virgule|point",
        "wordToNum": {
